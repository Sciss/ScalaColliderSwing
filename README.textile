...
Note that due to an incompatibility between Scala 2.8.1 and sbt 0.7.4, it is not possible to run using @sbt run@. You can use the application bundle instead on OS X:
...
pre. val dep1 = "de.sciss" %% "scalacolliderswing" % "0.25"
