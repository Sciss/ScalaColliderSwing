...
ScalaCollider-Swing currently compiles against the Scala 2.9.1 and requires Java 1.6. The repository contains a project file for Intellij IDEA 10.5 CE, and project files for sbt. Targets for xsbt (sbt 0.11):
