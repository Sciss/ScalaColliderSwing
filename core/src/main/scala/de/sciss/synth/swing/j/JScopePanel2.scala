...
import de.sciss.osc
import de.sciss.synth.swing.j.JScopeView2.Config
...
/** Component to view an oscilloscope for a real-time signal.
  ...
  */
abstract class AbstractScopePanel2 extends JPanel(new BorderLayout(0, 0)) with ScopeViewLike {
  // ---- abstract ----
  ...
  private[this] val _view         = new JScopeView2
...
class JScopePanel2 extends AbstractScopePanel2 {
